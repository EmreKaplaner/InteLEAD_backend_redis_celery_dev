...
AWS_QUERYSTRING_AUTH = False  # Allows public access to files

# Default file storage on AWS S3
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'sslmode': 'require' if not DEBUG else 'prefer',  # Enforce SSL in production only
        },
    }
}
